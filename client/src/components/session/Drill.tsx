  ...
  if (completed) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-in zoom-in-95 duration-500">
        ...
        <p className="text-muted-foreground mb-8">Great job exercising your wit today.</p>
        <div className="grid grid-cols-2 gap-4 w-full max-w-md mb-8">
          <Card>
            <CardContent className="p-4 text-center">
              <p className="text-sm text-muted-foreground">XP Earned</p>
              <p className="text-2xl font-bold text-primary">+{difficulty === 'beginner' ? 10 : difficulty === 'intermediate' ? 25 : 50}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
        ...
        <Button size="lg" onClick={handleFinish} className="w-full max-w-sm">
          Return to Dashboard
        </Button>
      </div>
    );
      ...
      {!active ? (
        <Card className="border-2 border-primary/10 shadow-xl">
          <CardContent className="p-8 text-center space-y-6">
            ...
            <h1 className="text-3xl font-heading font-bold capitalize">{difficulty} Drill</h1>
            ...
            <div className="flex justify-center pt-4">
              <Button size="lg" className="w-full max-w-xs text-lg h-12" onClick={handleStart}>
                Start Session
              </Button>
            </div>
          </CardContent>
        ...
        <div className="space-y-12">
          ...
          <Progress value={(timeLeft / (difficulty === 'beginner' ? 5 : difficulty === 'intermediate' ? 30 : 45)) * 100} className="h-2" />

          {/* Prompt Card */}
          <div className="relative">
             <div className="absolute inset-0 bg-linear-to-r from-primary/20 to-secondary/20 blur-3xl opacity-50 rounded-full pointer-events-none" />
             <div className="relative bg-white/50 backdrop-blur-sm border border-white/20 shadow-2xl rounded-3xl p-16 text-center min-h-[300px] flex items-center justify-center flex-col gap-6">
